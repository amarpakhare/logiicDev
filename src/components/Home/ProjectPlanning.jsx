...
const ProjectPlanning = () => {
	...
	return (
		<motion.section
			...
			className="flex flex-col lg:flex-row items-center justify-between p-8 sm:p-16 sm:m-10 bg-gradient-to-r from-white via-purple-100 to-blue-100 rounded-lg"
		>
			{/* Left Side - Image */}
			<motion.div
