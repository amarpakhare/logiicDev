...
const WhatWeDo = () => {
	...
	return (
		<motion.section
			...
			animate={isInView ? "visible" : "hidden"}
			variants={sectionVariants}
			className="flex flex-col items-center justify-center py-10 sm:py-14 lg:py-16 px-4 rounded-lg bg-gradient-to-r from-blue-100 via-purple-100 to-white animate-gradient-x sm:m-10"
		>
			{/* Wrapping the section in motion.div for fade-in effect */}
			<motion.div
				initial="hidden"
